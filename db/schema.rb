...
ActiveRecord::Schema.define(version: 20170227024743) do
  ...
  create_table "sports", force: :cascade do |t|
    t.integer  "participation_hours", default: 0, null: false
    t.integer  "user_id"
    t.integer  "team_id"
    t.string   "name"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "name"
    t.integer  "units_preference",          default: 1,     null: false
    t.decimal  "height_meters"
    t.decimal  "weight_kilograms"
    t.integer  "total_participation_hours", default: 0,     null: false
